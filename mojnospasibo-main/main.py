...
def create_startup_tab(tab):
    ...
    label = ctk.CTkLabel(startup_frame, text="Приложение \"Система учета в автосервисе\" \nразработано студентом группы п-12бн \nТороповым Семёном Михайловичем.\n\nДля начала работы, пожалуйста, выберите вкладку в навигационной панели сверху.", font=("Helvetica", 24))
    label.place(relx=0.5, rely=0.5, anchor='center')

# Функция для создания вкладок и добавления на вкладочный контроль
